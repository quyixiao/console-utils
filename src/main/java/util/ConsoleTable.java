...
public class ConsoleTable {
    ...
    public String toString() {
        ...
        return CStringUtils.join(getLines(), lineSep);
    }
    ...
    public static void main(String[] args) {
        ...
        //no header
        //new util.ConsoleTable.ConsoleTableBuilder().addRows(body).build().print();

        //restrict
        //header.add(new Cell("not restrict"));
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).restrict(false).build().print();
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).restrict(true).build().print();

        //"null"
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).nullPolicy(NullPolicy.NULL_STRING).build().print();
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).nullPolicy(NullPolicy.THROW).build().print();

        //line sep
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).lineSep("\n\n").build().print();

        //vertical sep & horizontal sep & join sep
        //new util.ConsoleTable.ConsoleTableBuilder().addHeaders(header).addRows(body).verticalSep("*").horizontalSep("*").joinSep("*").build().print();
    }
}
